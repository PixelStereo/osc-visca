...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.916626, 53.681458, 41.0, 14.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 5.0, 33.0, 14.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 47.386597, 151.0, 16.0 ],
					"text" : "s #1/save"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 6.0, 72.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 3.714294, 42.0, 16.285706 ],
					"text" : "save"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 171.939941, 151.0, 16.0 ],
					"text" : "s #1/load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 130.553345, 72.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 265.0, 3.714294, 42.0, 16.285706 ],
					"text" : "load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 69.939941, 72.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.5, 3.714294, 65.5, 16.285706 ],
					"text" : "update list"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.916626, 138.30188, 138.0, 16.0 ],
					"text" : "s #1/play"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 263.916626, 112.068054, 35.0, 16.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.916626, 53.681458, 131.0, 16.0 ],
					"text" : "r #1/list"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 104.939941, 151.0, 16.0 ],
					"text" : "s #1/update"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 268.689941, 140.0, 16.0 ],
					"text" : "s #1/store"
				}
...
,
					"patching_rect" : [ 17.0, 240.689941, 69.0, 16.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 207.05188, 72.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 25.0, 52.0, 20.0 ],
					"text" : "new"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.916626, 62.991516, 72.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 260.0, 25.0, 52.0, 20.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 212.916626, 96.068054, 155.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 26.0, 194.0, 18.0 ]
				}
